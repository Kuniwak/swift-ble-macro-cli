...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Kuniwak/swift-ble-macro.git", .upToNextMajor(from: "2.0.0")),
        .package(url: "https://github.com/Kuniwak/swift-logger.git", .upToNextMajor(from: "1.0.0")),
        .package(url: "https://github.com/Kuniwak/swift-ble-assigned-numbers", .upToNextMajor(from: "1.0.0")),
    ],
    targets: [
        .executableTarget(
            name: "BLECommandLine",
